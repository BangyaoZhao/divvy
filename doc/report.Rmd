...
To reduce dimension of the categorical variable $from\_station\_name$, we searched for information of the stations on the Divvy Bikes webpage and found location and scale for 611 stations, where we had:
Variable name    | Variable label
-----------------|---------------
...
## Data Cleaning
We first deleted data with user's age or gender missing. 562,565 out of 3,603,082 trips were deleted. We also noticed 2 out of 621 stations did not have any trips left.
...
We also noticed that some users had implausibly large age, some users being older than 100. We drew a histogram of user's age, as shown in Figure 3.

![Figure 3. Histogram of user's age](../plots/HistOfAge.png)

From Figure 3, we can see that there are very few people older than 75, so we further deleted these people. In this step, 2,407 out of 3,005,668 trips were deleted.
