...
![Map of Divvy Bikes stations](../plots/mapbox_black.png){width=200px} ![Map of Divvy Bikes stations, where spots in different colors represent stations in different clusters](../plots/mapbox.png){width=200px} ![Histogram of users' age](../plots/HistOfAge.png){width=200px} 
...
![A screenshot of our shiny app]("../plots/rshiny.PNG"){width=550px} 
